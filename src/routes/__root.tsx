...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "منصة زانا التعليمية" },
      {
        name: "description",
        content:
          "منصة زانا: تعليم تفاعلي للمرحلتين الابتدائية والإعدادية بالخرائط الذهنية والجولات الافتراضية وبيئات المحاكاة.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Baloo+Bhaijaan+2:wght@500;700;800&family=Cairo:wght@400;600;700&display=swap",
      },
